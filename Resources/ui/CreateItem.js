exports.CreateItemWindow = function(boardId) {
	...
	var data = [];
	data[0]=Ti.UI.createPickerRow({title:'High'});
	data[1]=Ti.UI.createPickerRow({title:'Medium'});
	data[2]=Ti.UI.createPickerRow({title:'Low'});
